...
public class HistoricoResource {
	...
	public Response save(@PathParam("id") final String id, final HistoricoImpl) {
		System.out.println("HistoricoResource.save()");
	...
	class HistoricoNew implements Historico {
